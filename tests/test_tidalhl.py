...
def tidal_signal_with_gaps():
    ...
    df = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data',
                                  'tidal_signal_with_gaps.csv'), parse_dates=[0], index_col=0, dtype='float')
    dfh = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data',
                                   'tidal_signal_with_gaps_highs.csv'), parse_dates=[0], index_col=0, dtype='float')
    dfl = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data',
                                   'tidal_signal_with_gaps_lows.csv'), parse_dates=[0], index_col=0, dtype='float')
    return df, dfh, dfl
...
def tidal_signal_with_disturbances():
    ...
    '''
    df = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data', 'tidal_signal_with_disturbances.csv'),
                     parse_dates=[0], index_col=0, dtype='float')
    dfh = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data', 'tidal_signal_with_disturbances_highs.csv'),
                      parse_dates=[0], index_col=0, dtype='float')
    dfl = pd.read_csv(os.path.join(os.path.dirname(__file__), 'data', 'tidal_signal_with_disturbances_lows.csv'),
                      parse_dates=[0], index_col=0, dtype='float')
    return df, dfh, dfl
